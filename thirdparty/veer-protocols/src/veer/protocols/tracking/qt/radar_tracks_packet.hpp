#ifndef VEER_PROTOCOLS_TRACKING_QT_RADAR_TRACKS_PACKET_HPP_
#define VEER_PROTOCOLS_TRACKING_QT_RADAR_TRACKS_PACKET_HPP_
...
inline QDebug operator<<( QDebug dbg, const RadarTracksPacketHeader value )
{
...
inline QDataStream& operator<<( QDataStream& ds, const RadarTracksPacketHeader& value )
{
...
inline QDataStream& operator>>( QDataStream& ds, RadarTracksPacketHeader& value )
{
...
inline QDataStream& operator<<( QDataStream& ds, RadarTracksData& value )
{
	value.updateSize();
...
#endif // ifndef VEER_PROTOCOLS_TRACKING_QT_RADAR_TRACKS_PACKET_HPP_
