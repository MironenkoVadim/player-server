#ifndef VEER_PROTOCOLS_TRACKING_QT_ADSB_TRACKS_PACKET_HPP_
#define VEER_PROTOCOLS_TRACKING_QT_ADSB_TRACKS_PACKET_HPP_
...
inline QDebug operator<<( QDebug dbg, const AdsbTracksPacketHeader value )
{
	QDebugStateSaver saver( dbg );
	dbg.nospace() << "(VPT::AdsbTracksPacketHeader: = [";
...
inline QDataStream& operator<<( QDataStream& ds, const AdsbTracksPacketHeader& value )
{
...
inline QDataStream& operator>>( QDataStream& ds, AdsbTracksPacketHeader& value )
{
...
inline QDataStream& operator<<( QDataStream& ds, AdsbTracksData& value )
{
	value.updateSize();
...
#endif // ifndef VEER_PROTOCOLS_TRACKING_QT_ADSB_TRACKS_PACKET_HPP_
